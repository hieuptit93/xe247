...
- Moderate border-radius: 8px buttons, 14px badges, 20px cards, 32px large elements
...
- **Normal spacing**: Balanced vertical padding between sections creates a standard browsing pace.
...
- Use moderate border-radius: 8px for buttons, 20px for cards, 50% for controls
...
5. Moderate radius: 8px buttons, 20px cards, 50% controls
